        ...
        <div class="grid-container">
            ...
            <main id="main-doc" class="content-docs">
                <section class="main-section" id="Try_YAWP">
                    ...
                    <p>
                        YAWP is not just yet another web playground. At its heart it lets your write code and see results on the fly.
                        <b>You can use YAWP to write code, see the results as you build, and take snippets of it as you go.</b> Whether
                        you want to get a taste of web, or interactively teach web lessons with options to save what you teach, 
                        YAWP docs will help you get started and fix problems as you face them.
                    </p>
                </section>
                <section class="main-section" id="Online_Playgrounds">
                    ...
                    <code>
                    A web playground does not mind you playing around as you wish. 
                    From useful and liberating online code editors to amazing production grade environments, 
                    playgrounds on internet help you learn, teach, play, test and more.
                    </code>
                </section>
                <section class="main-section" id="Getting Started">
                    ...
                    <p>
                        Go to <a href="https://yawp.vercel.app/play ">https://yawp.vercel.app/play </a> 
                        and start by typing HTML, CSS and JS on the respective editors.
                    </p>
                </section>
                <section class="main-section" id="Using Play">
                    ...
                    <p>
                        Once you are in YAWP, you can quickly start by writing custom HTML, CSS and Javascript. 
                        The results will appear on the right as you type.
                        If you are using YAWP for interactive lessons, it is recommended to use the floating action button for utilities. 
                    <ul>
                        <li>
                        You can make a snippet of the code on screen using the screenshot tool. 
                        The screenshot tool can be accessed using the bottom right floating action button.
                        </li>
                        <li>
                        ...
                        <li>
                        YAWL utilizes browser local storage to store your work. 
                        Next time you come to use YAWP, you can start where you left.
                        </li>
                    </ul>
                    </p>
                </section>
